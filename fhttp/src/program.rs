...
pub struct Args {
    ...
    #[arg(long, help = "fail the program instead of prompting for missing environment variables")]
    pub no_prompt: bool,

    #[arg(
        short, long, env = "FHTTP_PROFILE",
        help = "profile to use. can be set by env var FHTTP_PROFILE"
    )]
    pub profile: Option<String>,

    #[arg(
        short = 'f', long, env = "FHTTP_PROFILE_FILE",
    ...
    #[arg(short = 'P', long, help = "print request file paths instead of method and url")]
